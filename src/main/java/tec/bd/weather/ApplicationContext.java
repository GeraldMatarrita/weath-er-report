...
public class ApplicationContext {
    ...
    private IWeatherProvider imnProvider;
    ...
    public static ApplicationContext initIMN(){
        ApplicationContext applicationContext = new ApplicationContext();
        applicationContext.imnProvider = new IMNProvider();
        applicationContext.weatherReport = initWeatherReport(applicationContext.imnProvider);
        return applicationContext;
    }
